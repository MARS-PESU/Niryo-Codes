...
%setenv('ROS_MASTER_URI','http://192.168.25.176:11311') %IP of the Ned
%setenv('ROS_IP','192.168.25.248') %IP of the computer
% 
%ipaddress = "http://192.168.25.176:11311"; %IP of the Ned
%rosinit(ipaddress) 
%% 
