...
# ----------------------------------------Part to change ------------------------------------------------
leader_ip = "192.168.85.190"  # ip of the Leading robot
clients_ip = ["192.168.85.236", "192.168.85.33"]  # ips of the followers
# -------------------------------------------------------------------------------------------------------
    ...
    class RobotFollower(Thread):
        ...
        def run(self):
            ...
            while self.parent.go:
                ...
                jog_joints = [(desired - current)*0.3 for desired, current in zip(self.parent.desired_joint, joints)]
