...
robot_ip_address = "192.168.132,236"  # Replace by robot ip address
workspace = "ws_tensorflow"

observation_pose = PoseObject(  # position for the robot to watch the workspace
    x=-0.0022, y=0.1733, z=0.2081,
    roll=3.009, pitch=1.385, yaw=-1.701,
)

drop_pose = PoseObject(  # position for the robot to watch the workspace
    x=0.183, y=0.236, z=0.111,
    roll=-0.990, pitch=1.544, yaw=0.582,
)
